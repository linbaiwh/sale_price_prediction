...
# ### Loop a list of models and check the performance
...
# #### As for all five algorithms, I will end up taking GradientBootingRegressor, since this algorithm better than all algorithms in indicators(MAE, MSE).
...
parameters = {'gbr__learning_rate': [0.1], 
              ...
              'gbr__min_samples_leaf': range(30, 60, 90), 
...
model_gsv = GridSearchCV(model, parameters, cv = 3, scoring = scorer)
...
# - Cost and volum have higher predict power.
# - GradientBootingRegressor has a better performance in all listed five regressor and tree models.
# - The purchase prices normally spike in September and April, and decrease in June.
# 
